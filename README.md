...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/status-v0.0.19%20%C2%B7%20Phase%205a%20complete-orange" alt="Status: v0.0.19, Phase 5a complete">
</p>
...
v0.0.19, Phase 5a complete. Phases 1 (data layer), 2 (import/organize), 3 (browse), and 4 (playback) are done — a daily-driver music player — and metadata is editable from both the CLI and the GUI:
...
Next: Phase 5b (embedded-tag write-back).
