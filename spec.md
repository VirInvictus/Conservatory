...
**Version:** 0.4.3 (Phases 0–17 shipped, including Phase 9 (scrobbling, v0.3.1–v0.3.6) and Phase 26 (de-adwaita, `0.3.0`); the `0.4.0` milestone (Phases 19 + 9) is in flight with 19a, 19b-i, and 19b-ii shipped. See §17 and roadmap.md.)
