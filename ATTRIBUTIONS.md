...
| `wiremock` | MIT OR Apache-2.0 | Test-only: a local mock HTTP server for the fetcher's conditional-GET / 304 / 429 paths, so the suite stays hermetic (no real network) | 6a-ii-a (dev) |
